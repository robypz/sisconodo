...
if (isset($_GET["Buscar"])) {
    ...
    if (!isset($_GET["dni"]) && !isset($_GET["school"])) {
        $result = $c->select();
    }
} else {
    $result = $c->select();
...
<head>
    ...
    <title>SISCONODO: Contratos</title>
        ...
        <div id="container">
            ...
            <section id="content">
                <div id="section">
                    ...
                    <h2 id="section-name">Nómina</h2>
                    <div id="section-content">
                        <form action="contractController.php" method="get" id="nomina-form">
                            <input type="number" name="dni" placeholder="Cédula" value=0  placeholder="Cedula">
                        ...
                        <button id="nomina-report"><a href="contractReport.php?dni=<?php if (isset($_GET["dni"])) {
                                                                    echo $_GET["dni"];
                                                                } else {
                                                                    echo 0;
                                                                } ?>&school=<?php if (isset($_GET["school"])) {
                                                                                echo $_GET["school"];
                                                                            } else {
                                                                                echo "";
                        ...
                        <br>
                        <div id="nomina">
                            <table id="nomina-table" border="1">
